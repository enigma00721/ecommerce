...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('images/admin/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
  </div>
...
<!-- AdminLTE App -->js/pages/dashboard.js
<script src="{{url('js/admin/adminlte.js')}}"></script>
